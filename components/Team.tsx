      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {TEAM_MEMBERS.map((member, index) => (
            <div
              key={index}
              className="group w-full max-w-sm bg-white rounded-2xl p-8 shadow-lg 
              border border-slate-100 hover:border-teal-100 transition-all duration-300 hover:-translate-y-2"
            >
              <div className="flex flex-col items-center text-center h-full">
                ...
                <div className="flex items-center justify-center space-x-4 mb-6">
                  <a
                    ...
                    className="p-2 rounded-full bg-slate-50 text-slate-400 hover:text-blue-700 
                ...
                <a
                  ...
                  bg-slate-50 text-slate-600 text-sm font-medium hover:bg-teal-50 hover:text-teal-700 
                  transition-colors w-full break-all"
                >
